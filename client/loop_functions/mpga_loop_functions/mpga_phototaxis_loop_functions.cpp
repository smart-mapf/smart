...
CMPGAPhototaxisLoopFunctions::CMPGAPhototaxisLoopFunctions() : m_vecInitSetup(5),
                                                               m_pcFootBot(NULL),
                                                               m_pcController(NULL),
...
void CMPGAPhototaxisLoopFunctions::Init(TConfigurationNode &t_node)
{
   ...
   m_pcController = &dynamic_cast<CFootBotDiffusion &>(m_pcFootBot->GetControllableEntity().GetController());
